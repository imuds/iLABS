...
$ Appendix C
(a)  oxygen_ON = .true., flow_ON = true., Perm_Rec = .true. (in eParameters_IN.txt)
(c)  oxygen_ON = .true., flow_ON = true., Form_Rec = .true. (in eParameters_IN.txt), 0.6 Porosity of sediment (in Parameters_IN.txt) 
$ Appendix E
